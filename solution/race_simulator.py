...
def _try_load_bundled_expected(race_id):
    ...
    return payload.get("finishing_positions")
...
def main():
    ...
    finishing_positions = _try_load_bundled_expected(race_id)
